...
class ConsoleOutput {
  ...
  /**
   * Write Markdown. The default console output can't handle any Markdown
   * formatting, so it instead just dumps everything as-is. (As the intention
   * is to provide a look at what's being generated.)
   *
